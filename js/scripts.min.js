...
{elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"water",stylers:[{color:"#5dc7ff"}]},{featureType:"road",stylers:[{visibility:"on"}]},{featureType:"road",elementType:"labels",stylers:[{saturation:-30}]}],{name:"Zoomed Style"});c.mapTypes.set("default",f);c.mapTypes.set("zoomed",w);"logistics"===googleMaps?(c.setMapTypeId("default"),f=document.getElementById("location-input"),q=new google.maps.places.Autocomplete(f),google.maps.event.addListener(q,"place_changed",function(){t.setVisible(!1);
